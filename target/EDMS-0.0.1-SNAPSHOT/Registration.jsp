...
<!-- Form -->
<form class="my-3 max-w-[800px] mx-auto p-6 bg-white border-2 border-orange-300 rounded-lg shadow-lg" action="Registration" method="post" enctype="multipart/form-data"
>
