...
<div class="my-container grid grid-cols-1 lg:flex gap-5 p-5">
    ...
    <div class="static lg:sticky top-0">
        <div class="sticky top-5 flex flex-col gap-1 justify-center items-center p-5 shadow-lg rounded-lg min-w-[280px]">
            <img onclick="profile_img_modal.showModal()" class="cursor-pointer rounded-full w-[250px] h-[250px] mt-3"
            ...
            <h1 class="font-bold text-[20px] flex items-center justify-center gap-2"><% if (Verified != null) { %> <img
                    class="w-[30px] h-[30px]" src="IMAGES/badge-2.png" alt=""> <% } %><%=Name%>
            </h1>
            <h3 class="text-slate-500"><%=Type%>
            </h3>
            <h3 class="text-slate-500"><%=ContactNo%>
            </h3>
            ...
            <div>
                <div class="my-2 text-[15px] flex gap-1  flex-wrap">
                    ...
                    <div class="badge badge-ghost"><%=UserTownships%>
                    </div>
                </div>

                <div class="my-2 text-[15px] flex gap-1 flex-wrap">
                    <i class="fa-solid fa-location-dot"></i>
                    <div class="badge badge-ghost"><%=UserCities%>
                    </div>
                </div>

                <div class="my-2 text-[15px] flex gap-1 flex-wrap">
                    <i class="fa-solid fa-location-dot"></i>
                    <div class="badge badge-ghost"><%=UserDivisions%>
                    </div>
                </div>
            </div>
            ...
            <h2 class="mb-3 text-slate-600">Shelters Owned: <%=LocName.size()%>
            </h2>
        </div>
    </div>
    ...
    <div class="shadow-lg rounded-lg p-5 grow">
        <!-- User description -->
        <div class="bg-gray-100 p-3 lg:p-5 rounded-lg mb-5 border-2 border-yellow-500">
            <h1 class="text-slate-600 text-center text-[20px] mb-2">Representative Description</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <a href="AddPost.jsp">
                <button class="btn btn-warning w-full hover:bg-amber-500">Add Post</button>
            </a>
            <div class="flex gap-5 w-full">
                <a class="grow" href="AddLocation.jsp">
                    <button class="btn btn-warning hover:bg-amber-500 w-full">Add Location</button>
                </a>
        ...
        <div>
            ...
            <div class="bg-gray-100 p-3 lg:p-5 rounded-lg mb-5 border-4 border-yellow-500">
                <h1 class="text-slate-600 font-bold text-[20px] text-center">Shelters Added</h1>
                <!-- Locations Table -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-3">
                                    <div>
                                        <div class="font-bold"><a class="hover:text-red-500"
                                                                  href="Location_Profile.jsp?LocationUsernameFromShelterPage=<%=UUsername%>"><%=NName%>
                                        </a></div>
                                    </div>
                                </div>
                            </td>
            ...
            <div class="flex flex-col gap-5 overflow-hidden my-5">
                ...
                <div data-aos="fade-right" class="bg-[#d9d9d9] p-3 md:p-5 rounded-xl">
                    <div class="flex flex-col md:flex-row gap-3 justify-between">
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                %>
                                <h1 class="text-[16px] font-bold"><%=Name%>
                                </h1>
                                ...
                                <h3 class="text-[15px]"><%=PostDate.pop()%>
                                </h3>
                            </div>
                        </div>
                        ...
                        <%
                            if (PostAffected.peek() != -1) {
                        %>
                        <div class="badge badge-ghost text-[18px] p-3 border-1 border-black">Affected
                            People: <%=PostAffected.pop()%>
                        </div>
                    ...
                    <div class="my-2 text-[15px] flex gap-1 items-center">
                        <i class="fa-solid fa-location-dot"></i>
                        <div class="badge badge-ghost"><%=PostTownships.pop()%>
                        </div>
                        <div class="badge badge-ghost"><%=PostCities.pop()%>
                        </div>
                        <div class="badge badge-ghost"><%=PostDivisions.pop()%>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                        <div class="grid grid-cols-2 lg:flex gap-2">
                            ...
                            <dialog id="<%=take2%>" class="modal w-[100vw]">
                                <div class="modal-box max-w-[90vw] w-full lg:w-auto">
                                    <form method="dialog">
                                        <button class="btn btn-sm btn-circle btn-error text-white absolute right-2 top-2">
                                            X
                                        </button>
                                    </form>
                                    <div class="flex justify-center items-center">
                        ...
                        <div class="post-description flex flex-col justify-between">
                            ...
                            <p><%=PCobj.Print_200_Characters(PostDescription.peek())%>
                            </p>
                            ...
                            <div class="flex justify-end items-center">
                                ...
                                <dialog id="<%=take6%>" class="modal w-[100vw] h-[100vh]">
                                    <div class="modal-box max-w-[90vw] max-h-[70vh] w-full h-auto lg:w-auto">
                                        ...
                                        <p class="text-justify mt-4 text-[24px]"><%=PostDescription.pop()%>
                                        </p>
                                    </div>
                                </dialog>
                            </div>
                ...
                <div class='flex justify-between gap-0'>
                    ...
                    <div class='flex flex-col items-center justify-center gap-3 border-[1px] p-8 w-full'>
                        <a href='Home.jsp'>
                            <h1 class="font-extrabold text-5xl text-amber-600">edms<span class="text-red-500">.</span>
                            </h1>
                        </a>
                        <h3 class='text-[16px] text-[#7B7B7B] text-center'>EDMS - Your comprehensive resource for
                            shelter,
                    ...
                    <div class='hidden md:flex flex-col items-center justify-center gap-3 border-[1px] p-8 min-w-[250px]'>
                        ...
                        <a href='/'
                           class='text-[16px] text-[#868686] hover:text-black transition duration-500'>Terms</a>
                        <a href='/'
                           class='text-[16px] text-[#868686] hover:text-black transition duration-500'>Privacy</a>
                    </div>
                </div>
                <!-- End of Footer -->
